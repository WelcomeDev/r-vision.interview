 ...
 * ЗАДАЧА КАНДИДАТА.
 *
 * Мастер создания задачи на сканирование: 2 шага, валидация на каждом шаге,
 * данные не теряются при переходах назад/вперёд, на втором шаге — отправка
 * на «бэкенд», который может вернуть 422 с ошибками по полям.
 *
