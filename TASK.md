...
**MVP (на него ориентируемся по времени):** оба шага, навигация со Stepper, валидация каждого
шага, сохранение данных при возврате, отправка формы.

**Дальше по времени:** разбор 422 с переходом на нужный шаг, асинхронная проверка уникальности
имени, debounce поиска, фокус на первом невалидном поле.
